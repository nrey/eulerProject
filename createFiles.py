...
TEMP_FILE.write('  // ---------------------------------------------------- //\n')
TEMP_FILE.write('  m_tstart = (double)clock()/CLOCKS_PER_SEC;\n')
TEMP_FILE.write('  // ---------------------------------------------------- //\n')
TEMP_FILE.write('\n')
TEMP_FILE.write('  m_output = 0;\n')
TEMP_FILE.write('\n')
TEMP_FILE.write('  // ---------------------------------------------------- //\n')
TEMP_FILE.write('\n')
TEMP_FILE.write('  // ---------------------------------------------------- //\n')
TEMP_FILE.write('  m_tstop = (double)clock()/CLOCKS_PER_SEC;\n')
TEMP_FILE.write('  m_ttime = m_tstop-m_tstart;\n')
TEMP_FILE.write('  // ---------------------------------------------------- //\n')
TEMP_FILE.write('}\n')
TEMP_FILE.write('\n')
TEMP_FILE.write('void eu'+EULER_NUMBER+' :: printsolution(){\n')
TEMP_FILE.write('  std::cout << "Euler '+EULER_NUMBER+'\\n\";\n')
TEMP_FILE.write('  std::cout << "Time: " << m_ttime << "\\n\";\n')
TEMP_FILE.write('  std::cout << m_output;\n')
TEMP_FILE.write('}\n')
TEMP_FILE.close( )
